...
where EmailDipendente = 'mch@mail.com';DELETE FROM `tripdb`.`dipendente`;
...
VALUES('5','5');
INSERT INTO `tripdb`.`fme`(`MetaRappresentata`,`FotoMeta`)
VALUES('6','6');DELETE FROM `tripdb`.`fmo`; 
...
INSERT INTO `tripdb`.`postoprenotato`(  
  ...
  `NomePasseggero`,
  `CognomePasseggero`)
VALUES('3','3','24','Simone', 'Gaetani');DELETE FROM `tripdb`.`prenotazione`;
...
INSERT INTO `tripdb`.`soggiorno`(
    ...
    `DataInizioSoggiorno`, 
    `DataFineSoggiorno`)
VALUES('3','3','6','3','2022-07-12','2022-07-12');DELETE FROM `tripdb`.`tagliando`; 
